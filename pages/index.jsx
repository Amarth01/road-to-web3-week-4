...
const Home = () => {
  ...
  const [collection, secCollectionAddress] = useState("");
  ...
  const fetchNFTs = async() => {
    ...
    const baseURL = "https://eth-mainnet.alchemyapi.io/v2/wyQZ9BlIVkEv0CRI2c1Fc9aPVpF7ihdF/getNFTs/";
  ...
  const fetchNFTsForCollection= async () => {
    if (collection,length) {
      ...
      const baseURL = "https://eth-mainnet.alchemyapi.io/v2/wyQZ9BlIVkEv0CRI2c1Fc9aPVpF7ihdF/getNFTsForCollection/";
      const fetchURL = `${baseURL}?contractAddress=${collection}&withMetadata%5B%5D=${"true"}`;
